...
class LoggingInterceptor private constructor(private val builder: Builder) : Interceptor {
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        if (builder.responseFlag) {
            ...
            if (subtypeIsNotFile(subtype)) {
                ...
                Logger.printJsonResponse(builder, chainMs, isSuccessful, code, header, bodyString, request.url())
            } else {
                Logger.printFileResponse(builder, chainMs, isSuccessful, code, header, request.url())
            }
        }
    ...
    class Builder {
        ...
        var requestLogLevel: LogLevel = LogLevel.DEBUG
        var responseLogLevel: LogLevel = LogLevel.INFO
        ...
        fun requestLogLevel(logLevel: LogLevel): Builder {
            this.requestLogLevel = logLevel
            return this
        }


        fun responseLogLevel(logLevel: LogLevel): Builder {
